...
A summary of core feature releases.
...
- **Easier content management:** new field types UI, easier handling of terms, menu items and media
- **More flexible block placement:** place blocks depending on http status (404 or 403)
- **New built-in file name sanitization options**: transliteration is now in core
- **Faster permission management**: permissions now have a filter
- **Performance improvements**: better caching and faster rendering
- **PHP support**: support for PHP 8.3 and PHP attributes
- **Built-in project news updates**: `Announcements Feed` module is now installed by default (standard profile)
- **Developer experience improvements**: `PerformanceTestBase` and various other improvements
