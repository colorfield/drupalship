...
Ce sujet peut être étendu avec [Site Audit](https://www.drupal.org/docs/develop/standards/coding-standards) et [Security Review](https://www.drupal.org/project/security_review). Fondamentalement, tester les scénarios d'accès anonymes simultanés et conséquents et le comportement lorsque chaque cache est activé.
