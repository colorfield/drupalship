---
title: (FR) Is Drupal the right solution for my project?
---

(FR) Drupal is a Content Management System (CMS), but the community prefers the Content Management _Framework_ term because of its versatility and the wide range of use cases it can cover.
...
*   A **decoupled frontend** like React, ELM, Ionic, Angular, ... that needs a backend? Try Drupal [Contenta](http://www.contentacms.org/) or [Reservoir](https://github.com/acquia/reservoir) or just install the Drupal core with [JSON API](https://www.drupal.org/project/jsonapi) or [GraphQL](https://www.drupal.org/project/graphql).  
...
*   The [new user-facing core theme initiative](https://www.drupal.org/node/2759849)
...
You may have heard that Drupal 7 is more easy to implement, but consider the new [release cycle](/develop/drupal-8-release-cycle) in Drupal 8 that will be sustainable between major versions.

[Should I Use Drupal 7 or Drupal 8?](https://www.ostraining.com/blog/drupal/7-vs-8/)

[Test Drupal 8](https://simplytest.me/project/drupal/8.4.x) or [Install it](/build/installation-drupal-8-core-and-contributed-projects)
