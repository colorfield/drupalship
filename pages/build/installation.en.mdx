...
It comes with some demo content, translations and a few other modules enabled. Use this if you want to evaluate a more complete set of Drupal features.
...
Once you found a [module or theme](/build/modules-themes-distributions) to install, you can use Composer.

```bash
composer require drupal/[project_name]
```
Then enable the project with the UI or [Drush](/develop/toolkit-for-drupal-developers#drush-cli).
