...
Vous pouvez également trouver de la [documentation sur Drupal.org](https://www.drupal.org/docs/upgrading-drupal/upgrading-from-drupal-8-or-later/how-to-upgrade-from-drupal-9-to-drupal-10).
