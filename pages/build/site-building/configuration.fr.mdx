...
Utilisez le module **[Pathauto](/project/module/pathauto)**.

## Redirigez les URL

Pour corriger les 404 ou pour gérer le renommage automatique des URL, utilisez le module **[Redirect](/project/module/redirect)**.

## Choisissez entre décimal ou flottant

![Choisir entre flottant ou décimal](/sites/default/files/inline-images/float-or-decimal.png)
...
Le **[Content Access](https://www.drupal.org/project/content_access)** (toujours en développement pour Drupal 8) couvre l'accès au contenu par type de contenu avec des valeurs par défaut et la possibilité de les remplacer par contenu.
...
*   Installez les [Modules de contrôle du spam](/build/modules-themes-distributions#spam-control)
