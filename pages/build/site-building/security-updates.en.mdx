...
Some [hosting companies dedicated to Drupal](/deploy/drupal-hosting-for-evaluation-and-production#medium-to-large-projects) are also providing extra security services, but the security update should still be done.
