...
`drush generate` [command](https://www.drush.org/12.x/commands/generate/) est basé sur le projet [drupal-code-generator](https://github.com/Chi-teck/drupal-code-generator).

[Drupal Console](https://drupalconsole.com/) est un excellent outil qui a aidé les développeurs de Drupal 8 de bien des manières, mais il est maintenant [deprecated](https://github.com/hechoendrupal/drupal-console/issues/4323), principalement en faveur de Drush.
