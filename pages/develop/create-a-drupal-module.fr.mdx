...
qui vous fournira la plupart du code de base, ou [Exemples pour les développeurs](https://www.drupal.org/project/examples).

Vous pouvez aussi consulter les autres projets liés à [l'expérience de développement](https://www.drupalship.org/fr/build/modules-themes-distributions#exp%C3%A9rience-de-d%C3%A9veloppement).
