...
<Callout type="warning">Documentation is under revision. Some contents are not complete yet.</Callout>
...
If you need to implement a rather common feature, chances are that [there is a module for that](/build/modules-themes-distributions), so you don't have to reinvent the wheel.
...
[Cache API](https://www.drupal.org/docs/drupal-apis/cache-api) - Drupal.org
...
[Form API - validation](https://www.drupal.org/docs/drupal-apis/form-api/introduction-to-form-api#fapi-validation) - Drupal.org
...
[Validation constraints](https://www.drupal.org/docs/drupal-apis/entity-api/entity-validation-api/defining-constraints-validations-on-entities-andor-fields) - Drupal.org
